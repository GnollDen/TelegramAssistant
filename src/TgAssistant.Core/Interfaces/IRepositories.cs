...
public interface IOperatorResolutionApplicationService
{
    ...
    Task<OperatorPersonWorkspaceSummaryQueryResult> QueryPersonWorkspaceSummaryAsync(
    ...
    Task<OperatorPersonWorkspaceProfileQueryResult> QueryPersonWorkspaceProfileAsync(
        OperatorPersonWorkspaceProfileQueryRequest request,
        CancellationToken ct = default);

    Task<OperatorPersonWorkspacePairDynamicsQueryResult> QueryPersonWorkspacePairDynamicsAsync(
        OperatorPersonWorkspacePairDynamicsQueryRequest request,
        CancellationToken ct = default);

    Task<OperatorPersonWorkspaceTimelineQueryResult> QueryPersonWorkspaceTimelineAsync(
    ...
    Task<OperatorPersonWorkspaceRevisionsQueryResult> QueryPersonWorkspaceRevisionsAsync(
        OperatorPersonWorkspaceRevisionsQueryRequest request,
        CancellationToken ct = default);

    Task<OperatorPersonWorkspaceResolutionQueryResult> QueryPersonWorkspaceResolutionAsync(
        OperatorPersonWorkspaceResolutionQueryRequest request,
        CancellationToken ct = default);

    Task<OperatorPersonWorkspaceHistoryQueryResult> QueryPersonWorkspaceHistoryAsync(
        OperatorPersonWorkspaceHistoryQueryRequest request,
        CancellationToken ct = default);

    Task<OperatorPersonWorkspaceCurrentWorldQueryResult> QueryPersonWorkspaceCurrentWorldAsync(
